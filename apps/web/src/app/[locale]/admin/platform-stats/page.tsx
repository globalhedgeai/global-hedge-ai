  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold gradient-text mb-2">Platform Statistics</h1>
          <p className="text-muted-foreground text-lg">Real-time platform metrics and analytics</p>
        </div>
