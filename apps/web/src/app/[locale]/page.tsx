  ...
  return (
        ...
        >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-3xl mx-auto">
                  ...
                  <div className="text-center">
                    ...
                    <div className="text-sm text-muted-foreground font-medium">{t('dashboard.activeTrades')}</div>
                  </div>
                </div>
              </div>
      </div>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div className="bg-card border border-border rounded-xl p-6 text-center hover:shadow-xl transition-shadow">
                  ...
                  <h3 className="text-lg font-semibold text-foreground mb-3">{t('landing.feature1Title')}</h3>
                ...
                <div className="bg-card border border-border rounded-xl p-6 text-center hover:shadow-xl transition-shadow">
                  ...
                  <h3 className="text-lg font-semibold text-foreground mb-3">{t('landing.feature2Title')}</h3>
                ...
                <div className="bg-card border border-border rounded-xl p-6 text-center hover:shadow-xl transition-shadow">
                  ...
                  <h3 className="text-lg font-semibold text-foreground mb-3">{t('landing.feature3Title')}</h3>
                ...
                <div className="bg-card border border-border rounded-xl p-6 text-center hover:shadow-xl transition-shadow">
                  ...
                  <h3 className="text-lg font-semibold text-foreground mb-3">{t('landing.feature4Title')}</h3>
