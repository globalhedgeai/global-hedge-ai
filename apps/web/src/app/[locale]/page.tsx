                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    <div className="card hover-lift text-center p-6">
                      ...
                      <h3 className="text-xl font-semibold text-foreground mb-3">{t('landing.feature1Title')}</h3>
                    ...
                    <div className="card hover-lift text-center p-6">
                      ...
                      <h3 className="text-xl font-semibold text-foreground mb-3">{t('landing.feature2Title')}</h3>
                    ...
                    <div className="card hover-lift text-center p-6">
                      ...
                      <h3 className="text-xl font-semibold text-foreground mb-3">{t('landing.feature3Title')}</h3>
                    ...
                    <div className="card hover-lift text-center p-6">
                      ...
                      <h3 className="text-xl font-semibold text-foreground mb-3">{t('landing.feature4Title')}</h3>
